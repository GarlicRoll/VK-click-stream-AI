...
# Препроцессинг и обучение моделей
...
# Создание словарей для всех хешей и токенов
tokens_dict = make_final_dict(df.tokens)
hashes_dict = make_final_dict(df.urls_hashed)

# Создание пустых dataframe для токено ви хешей (каждый столбец - отдельный параметр)
...
# Сохранение
joblib.dump(model1, "model1big")
joblib.dump(model2, "model2big")
joblib.dump(model3, "model3big")